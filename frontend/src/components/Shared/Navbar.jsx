...
import logo from '../../assets/transparenticon.png'; // Asegúrate de usar la ruta correcta para tu imagen
            ...
            <div className='flex max-w-7xl items-center justify-between m-auto h-full'>
                <div className='flex items-center'>
                    <img 
                        src={logo} 
                        alt="Logo" 
                        className='w-16 h-16 mr-2' // Ajusta el tamaño según tus necesidades
                    />
                    <div className='text-5xl'>An Sinh Hospital</div> {/* Texto junto a la imagen */}
                </div>
                ...
                <svg className={isMobNav ? 'size-10 md:hidden cursor-pointer z-50 text-white' : 'size-10 md:hidden cursor-pointer z-50'} onClick={handleNav} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
